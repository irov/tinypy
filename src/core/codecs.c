...
static int32_t __tinypy_codecs_require_text(tinypy_vm_t *vm, tinypy_value_t *value, tinypy_error_t **out_error)
{
    ...
    if (kind == TINYPY_VALUE_STRING || kind == TINYPY_VALUE_UNICODE) return INT32_C(1);
...
static tinypy_value_t *__tinypy_codecs_normalize(tinypy_vm_t *vm, tinypy_value_t *name)
{
    ...
    for (source_index = 0U; source_index < source_size; source_index += 1U) {
        ...
        if ((character >= (unsigned char)'a' && character <= (unsigned char)'z') || (character >= (unsigned char)'0' && character <= (unsigned char)'9') || character == (unsigned char)'.') {
            if (separator != 0 && normalized_size != 0U) normalized[normalized_size++] = (unsigned char)'_';
...
static tinypy_value_t *__tinypy_codecs_register(tinypy_value_t *function, tinypy_value_t *args, tinypy_value_t *kwargs, void *user_data, tinypy_error_t **out_error)
{
    ...
    if (__tinypy_codecs_arguments(vm, args, kwargs, 1U, 1U, out_error) == 0) return NULL;
    ...
    tinypy_list_append(__tinypy_codecs_module_value(module, "_search_path", 12U), search);
...
static tinypy_value_t *__tinypy_codecs_lookup(tinypy_value_t *function, tinypy_value_t *args, tinypy_value_t *kwargs, void *user_data, tinypy_error_t **out_error)
{
    ...
    if (__tinypy_codecs_require_text(vm, name, out_error) == 0) return NULL;
    ...
    for (index = 0U; index < tinypy_list_size(search_path); index += 1U) {
        ...
        tinypy_value_t *result = tinypy_call(tinypy_list_get(search_path, index), search_args, NULL, out_error);
...
static tinypy_value_t *__tinypy_codecs_call_text(tinypy_vm_t *vm, tinypy_value_t *input, const char *method_name, tinypy_value_t *encoding, tinypy_value_t *errors, tinypy_error_t **out_error)
{
    ...
    if (__tinypy_codecs_require_text(vm, input, out_error) == 0) return NULL;
...
static tinypy_value_t *__tinypy_codecs_specific(tinypy_value_t *function, tinypy_value_t *args, tinypy_value_t *kwargs, void *user_data, tinypy_error_t **out_error)
{
    ...
    if (__tinypy_codecs_arguments(vm, args, kwargs, 1U, maximum, out_error) == 0) return NULL;
    input = tinypy_tuple_get(args, 0U);
    if (tinypy_tuple_size(args) >= 2U) errors = tinypy_tuple_get(args, 1U);
...
static tinypy_value_t *__tinypy_codecs_transform(tinypy_value_t *function, tinypy_value_t *args, tinypy_value_t *kwargs, void *user_data, tinypy_error_t **out_error)
{
    ...
    int32_t decode = tinypy_internal_text_byte_size(function_name) == 6U && memcmp(tinypy_internal_text_bytes(function_name), "decode", 6U) == 0;

    if (__tinypy_codecs_arguments(vm, args, kwargs, 2U, 3U, out_error) == 0) return NULL;
    input = tinypy_tuple_get(args, 0U);
    encoding = tinypy_tuple_get(args, 1U);
    if (__tinypy_codecs_require_text(vm, encoding, out_error) == 0) return NULL;
    if (tinypy_tuple_size(args) == 3U) errors = tinypy_tuple_get(args, 2U);
    ...
    if (errors == NULL) tinypy_release(call_items[1]);
...
static tinypy_value_t *__tinypy_codecs_register_error(tinypy_value_t *function, tinypy_value_t *args, tinypy_value_t *kwargs, void *user_data, tinypy_error_t **out_error)
{
    ...
    if (__tinypy_codecs_arguments(vm, args, kwargs, 2U, 2U, out_error) == 0) return NULL;
    name = tinypy_tuple_get(args, 0U);
    ...
    tinypy_dict_set(__tinypy_codecs_module_value(module, "_errors", 7U), name, handler);
    return tinypy_none_get(vm);
}
...
static tinypy_value_t *__tinypy_codecs_error_handler(tinypy_value_t *function, tinypy_value_t *args, tinypy_value_t *kwargs, void *user_data, tinypy_error_t **out_error)
{
    ...
    (void)user_data;
    if (__tinypy_codecs_arguments(vm, args, kwargs, 1U, 1U, out_error) == 0) return NULL;
    (void)tinypy_exception_raise(tinypy_tuple_get(args, 0U), NULL, out_error);
    return NULL;
}
...
void tinypy_internal_initialize_codecs_module(tinypy_vm_t *vm)
{
    ...
    function = __tinypy_codecs_add_function(vm, module, "register", 8U, __tinypy_codecs_register, module); tinypy_release(function);
    function = __tinypy_codecs_add_function(vm, module, "lookup", 6U, __tinypy_codecs_lookup, module); tinypy_release(function);
    function = __tinypy_codecs_add_function(vm, module, "encode", 6U, __tinypy_codecs_transform, module); tinypy_release(function);
    function = __tinypy_codecs_add_function(vm, module, "decode", 6U, __tinypy_codecs_transform, module); tinypy_release(function);
    function = __tinypy_codecs_add_function(vm, module, "register_error", 14U, __tinypy_codecs_register_error, module); tinypy_release(function);
    function = __tinypy_codecs_add_function(vm, module, "lookup_error", 12U, __tinypy_codecs_lookup_error, module); tinypy_release(function);
    function = __tinypy_codecs_add_function(vm, module, "utf_8_encode", 12U, __tinypy_codecs_specific, (void *)(intptr_t)0); tinypy_release(function);
    function = __tinypy_codecs_add_function(vm, module, "utf_8_decode", 12U, __tinypy_codecs_specific, (void *)(intptr_t)1); tinypy_release(function);
    function = __tinypy_codecs_add_function(vm, module, "ascii_encode", 12U, __tinypy_codecs_specific, (void *)(intptr_t)2); tinypy_release(function);
    function = __tinypy_codecs_add_function(vm, module, "ascii_decode", 12U, __tinypy_codecs_specific, (void *)(intptr_t)3); tinypy_release(function);
    function = __tinypy_codecs_add_function(vm, module, "latin_1_encode", 14U, __tinypy_codecs_specific, (void *)(intptr_t)4); tinypy_release(function);
    function = __tinypy_codecs_add_function(vm, module, "latin_1_decode", 14U, __tinypy_codecs_specific, (void *)(intptr_t)5); tinypy_release(function);
    ...
    for (index = 0U; index < 5U; index += 1U) {
        ...
        tinypy_dict_set(__tinypy_codecs_module_value(module, "_errors", 7U), key, function);
        tinypy_release(key);
