...
static tinypy_bool_t __tinypy_symbol_analyze(tinypy_symbol_table_t *st);
static tinypy_bool_t __tinypy_symbol_warn(tinypy_symbol_table_t *st, tinypy_value_t *warn, const char *msg, int32_t lineno);
static tinypy_bool_t __tinypy_symbol_enter_block(tinypy_symbol_table_t *st, tinypy_ast_identifier_t name, tinypy_symbol_block_e block, void *ast, int32_t lineno);
static tinypy_bool_t __tinypy_symbol_exit_block(tinypy_symbol_table_t *st, void *ast);
static tinypy_bool_t __tinypy_symbol_visit_stmt(tinypy_symbol_table_t *st, tinypy_ast_statement_t s);
static tinypy_bool_t __tinypy_symbol_visit_expr(tinypy_symbol_table_t *st, tinypy_ast_expression_t s);
static tinypy_bool_t __tinypy_symbol_visit_listcomp(tinypy_symbol_table_t *st, tinypy_ast_expression_t e);
static tinypy_bool_t __tinypy_symbol_visit_genexp(tinypy_symbol_table_t *st, tinypy_ast_expression_t s);
static tinypy_bool_t __tinypy_symbol_visit_setcomp(tinypy_symbol_table_t *st, tinypy_ast_expression_t e);
static tinypy_bool_t __tinypy_symbol_visit_dictcomp(tinypy_symbol_table_t *st, tinypy_ast_expression_t e);
static tinypy_bool_t __tinypy_symbol_visit_arguments(tinypy_symbol_table_t *st, tinypy_ast_arguments_t);
static tinypy_bool_t __tinypy_symbol_visit_excepthandler(tinypy_symbol_table_t *st, tinypy_ast_exception_handler_t);
static tinypy_bool_t __tinypy_symbol_visit_alias(tinypy_symbol_table_t *st, tinypy_ast_alias_t);
static tinypy_bool_t __tinypy_symbol_visit_comprehension(tinypy_symbol_table_t *st, tinypy_ast_comprehension_t);
static tinypy_bool_t __tinypy_symbol_visit_keyword(tinypy_symbol_table_t *st, tinypy_ast_keyword_t);
static tinypy_bool_t __tinypy_symbol_visit_slice(tinypy_symbol_table_t *st, tinypy_ast_slice_t);
static tinypy_bool_t __tinypy_symbol_visit_params(tinypy_symbol_table_t *st, tinypy_ast_sequence_t *args, tinypy_bool_t top);
static tinypy_bool_t __tinypy_symbol_visit_params_nested(tinypy_symbol_table_t *st, tinypy_ast_sequence_t *args);
static tinypy_bool_t __tinypy_symbol_implicit_arg(tinypy_symbol_table_t *st, int32_t pos);
...
tinypy_symbol_entry_t *__tinypy_symbol_table_lookup(tinypy_symbol_table_t *st, void *key) {
    ...
    tinypy_symbol_entry_t *return_value_1 = __tinypy_symbol_entry_from_handle(v);
...
int32_t __tinypy_symbol_table_scope(tinypy_symbol_entry_t *ste, tinypy_value_t *name) {
    ...
    int32_t return_value_1 = (TINYPY_COMPILER_INT_AS_LONG(v) >> TINYPY_SYMBOL_SCOPE_OFFSET) & TINYPY_SYMBOL_SCOPE_MASK;
    return return_value_1;
}
...
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __analyze_name(tinypy_symbol_entry_t *ste, tinypy_value_t *dict, tinypy_value_t *name, long flags, tinypy_value_t *bound, tinypy_value_t *local, tinypy_value_t *free, tinypy_value_t *global) {
...
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __analyze_cells(tinypy_value_t *scope, tinypy_value_t *free) {
...
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __check_unoptimized(const tinypy_symbol_entry_t *ste) {
    const char *name;
    size_t name_size;
    const char *trailer;
    size_t trailer_size;
 ...
 */
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __update_symbols(tinypy_value_t *symbols, tinypy_value_t *scope, tinypy_value_t *bound, tinypy_value_t *free, tinypy_bool_t classflag) {
...
static tinypy_bool_t __analyze_child_block(tinypy_symbol_entry_t *entry, tinypy_value_t *bound, tinypy_value_t *free, tinypy_value_t *global, tinypy_value_t *child_free);

//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __analyze_block(tinypy_symbol_entry_t *ste, tinypy_value_t *bound, tinypy_value_t *free, tinypy_value_t *global) {
...
static long __tinypy_symbol_lookup(tinypy_symbol_table_t *st, tinypy_value_t *name) {
    ...
    long return_value_1 = TINYPY_COMPILER_INT_AS_LONG(o);
    return return_value_1;
}
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __tinypy_symbol_add_def(tinypy_symbol_table_t *st, tinypy_value_t *name, int32_t flag) {
    long val;
    tinypy_value_t *mangled = __tinypy_frontend_mangle(st->arena, st->private_name, name);
...
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __tinypy_symbol_visit_expr(tinypy_symbol_table_t *st, tinypy_ast_expression_t e) {
    switch (e->kind) {
...
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __tinypy_symbol_visit_params(tinypy_symbol_table_t *st, tinypy_ast_sequence_t *args, tinypy_bool_t toplevel) {
    int32_t i;
...
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __tinypy_symbol_visit_arguments(tinypy_symbol_table_t *st, tinypy_ast_arguments_t a) {
...
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __tinypy_symbol_visit_excepthandler(tinypy_symbol_table_t *st, tinypy_ast_exception_handler_t eh) {
...
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __tinypy_symbol_visit_alias(tinypy_symbol_table_t *st, tinypy_ast_alias_t a) {
...
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __tinypy_symbol_visit_comprehension(tinypy_symbol_table_t *st, tinypy_ast_comprehension_t lc) {
...
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __tinypy_symbol_visit_keyword(tinypy_symbol_table_t *st, tinypy_ast_keyword_t k) {
    TINYPY_SYMBOL_VISIT(st, expr, k->value);
    return TINYPY_TRUE;
}
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __tinypy_symbol_visit_slice(tinypy_symbol_table_t *st, tinypy_ast_slice_t s) {
    switch (s->kind) {
...
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __tinypy_symbol_new_tmpname(tinypy_symbol_table_t *st) {
...
static tinypy_bool_t __tinypy_symbol_handle_comprehension(tinypy_symbol_table_t *st, tinypy_ast_expression_t e, tinypy_ast_identifier_t scope_name, tinypy_ast_sequence_t *generators, tinypy_ast_expression_t elt, tinypy_ast_expression_t value) {
    tinypy_bool_t is_generator = e->kind == TINYPY_AST_KIND_GENERATOR_EXP ? TINYPY_TRUE : TINYPY_FALSE;
    tinypy_bool_t needs_tmp = !is_generator;
    ...
    tinypy_bool_t return_value_1 = __tinypy_symbol_exit_block(st, (void *)e);
    return return_value_1;
}
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __tinypy_symbol_visit_listcomp(tinypy_symbol_table_t *st, tinypy_ast_expression_t e) {
...
//////////////////////////////////////////////////////////////////////////
static tinypy_bool_t __tinypy_symbol_visit_genexp(tinypy_symbol_table_t *st, tinypy_ast_expression_t e) {
    tinypy_value_t *symbol_identifier = __tinypy_symbol_identifier(st, &st->generator_expression_name, "genexpr");
    tinypy_bool_t return_value_1 = __tinypy_symbol_handle_comprehension(st, e, symbol_identifier,
