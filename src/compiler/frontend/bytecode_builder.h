...
#define TINYPY_COMPILER_OPCODE_HAS_ARGUMENT(opcode) ((opcode) >= (int32_t)TINYPY_OPCODE_HAVE_ARGUMENT)

#define __tinypy_bytecode_free_variable_count(code) ((int32_t)tinypy_tuple_size((code)->freevars))
