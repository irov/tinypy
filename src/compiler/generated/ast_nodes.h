...
typedef enum tinypy_ast_expression_context_e { TINYPY_AST_CONTEXT_LOAD=1, TINYPY_AST_CONTEXT_STORE=2, TINYPY_AST_CONTEXT_DELETE=3, TINYPY_AST_CONTEXT_AUGMENTED_LOAD=4, TINYPY_AST_CONTEXT_AUGMENTED_STORE=5,
                             TINYPY_AST_CONTEXT_PARAMETER=6 } tinypy_ast_expression_context_e;

typedef struct tinypy_ast_slice_s *tinypy_ast_slice_t;

typedef enum tinypy_ast_boolean_operator_e { TINYPY_AST_BOOLEAN_AND=1, TINYPY_AST_BOOLEAN_OR=2 } tinypy_ast_boolean_operator_e;

typedef enum tinypy_ast_binary_operator_e { TINYPY_AST_BINARY_ADD=1, TINYPY_AST_BINARY_SUBTRACT=2, TINYPY_AST_BINARY_MULTIPLY=3, TINYPY_AST_BINARY_DIVIDE=4, TINYPY_AST_BINARY_MODULO=5, TINYPY_AST_BINARY_POWER=6, TINYPY_AST_BINARY_LEFT_SHIFT=7,
                         TINYPY_AST_BINARY_RIGHT_SHIFT=8, TINYPY_AST_BINARY_BIT_OR=9, TINYPY_AST_BINARY_BIT_XOR=10, TINYPY_AST_BINARY_BIT_AND=11, TINYPY_AST_BINARY_FLOOR_DIVIDE=12 }
                         tinypy_ast_binary_operator_e;

typedef enum tinypy_ast_unary_operator_e { TINYPY_AST_UNARY_INVERT=1, TINYPY_AST_UNARY_NOT=2, TINYPY_AST_UNARY_ADD=3, TINYPY_AST_UNARY_SUBTRACT=4 } tinypy_ast_unary_operator_e;

typedef enum tinypy_ast_compare_operator_e { TINYPY_AST_COMPARE_EQUAL=1, TINYPY_AST_COMPARE_NOT_EQUAL=2, TINYPY_AST_COMPARE_LESS=3, TINYPY_AST_COMPARE_LESS_EQUAL=4, TINYPY_AST_COMPARE_GREATER=5, TINYPY_AST_COMPARE_GREATER_EQUAL=6, TINYPY_AST_COMPARE_IS=7, TINYPY_AST_COMPARE_IS_NOT=8,
                      TINYPY_AST_COMPARE_IN=9, TINYPY_AST_COMPARE_NOT_IN=10 } tinypy_ast_compare_operator_e;
...
typedef enum tinypy_ast_module_kind_e {TINYPY_AST_KIND_MODULE=1, TINYPY_AST_KIND_INTERACTIVE=2, TINYPY_AST_KIND_EXPRESSION=3,
                 TINYPY_AST_KIND_SUITE=4} tinypy_ast_module_kind_e;
...
typedef enum tinypy_ast_statement_kind_e {TINYPY_AST_KIND_FUNCTION_DEF=1, TINYPY_AST_KIND_CLASS_DEF=2, TINYPY_AST_KIND_RETURN=3,
                  TINYPY_AST_KIND_DELETE=4, TINYPY_AST_KIND_ASSIGN=5, TINYPY_AST_KIND_AUG_ASSIGN=6, TINYPY_AST_KIND_PRINT=7,
                  TINYPY_AST_KIND_FOR=8, TINYPY_AST_KIND_WHILE=9, TINYPY_AST_KIND_IF=10, TINYPY_AST_KIND_WITH=11,
                  TINYPY_AST_KIND_RAISE=12, TINYPY_AST_KIND_TRY_EXCEPT=13, TINYPY_AST_KIND_TRY_FINALLY=14,
                  TINYPY_AST_KIND_ASSERT=15, TINYPY_AST_KIND_IMPORT=16, TINYPY_AST_KIND_IMPORT_FROM=17,
                  TINYPY_AST_KIND_EXEC=18, TINYPY_AST_KIND_GLOBAL=19, TINYPY_AST_KIND_EXPR=20, TINYPY_AST_KIND_PASS=21,
                  TINYPY_AST_KIND_BREAK=22, TINYPY_AST_KIND_CONTINUE=23} tinypy_ast_statement_kind_e;
...
typedef enum tinypy_ast_expression_kind_e {TINYPY_AST_KIND_BOOL_OP=1, TINYPY_AST_KIND_BIN_OP=2, TINYPY_AST_KIND_UNARY_OP=3, TINYPY_AST_KIND_LAMBDA=4,
                  TINYPY_AST_KIND_IF_EXP=5, TINYPY_AST_KIND_DICT=6, TINYPY_AST_KIND_SET=7, TINYPY_AST_KIND_LIST_COMP=8,
                  TINYPY_AST_KIND_SET_COMP=9, TINYPY_AST_KIND_DICT_COMP=10, TINYPY_AST_KIND_GENERATOR_EXP=11,
                  TINYPY_AST_KIND_YIELD=12, TINYPY_AST_KIND_COMPARE=13, TINYPY_AST_KIND_CALL=14, TINYPY_AST_KIND_REPR=15,
                  TINYPY_AST_KIND_NUM=16, TINYPY_AST_KIND_STR=17, TINYPY_AST_KIND_ATTRIBUTE=18,
                  TINYPY_AST_KIND_SUBSCRIPT=19, TINYPY_AST_KIND_NAME=20, TINYPY_AST_KIND_LIST=21, TINYPY_AST_KIND_TUPLE=22} tinypy_ast_expression_kind_e;
...
typedef enum tinypy_ast_slice_kind_e {TINYPY_AST_KIND_ELLIPSIS=1, TINYPY_AST_KIND_SLICE=2, TINYPY_AST_KIND_EXT_SLICE=3, TINYPY_AST_KIND_INDEX=4} tinypy_ast_slice_kind_e;
...
typedef enum tinypy_ast_exception_handler_kind_e {TINYPY_AST_KIND_EXCEPT_HANDLER=1} tinypy_ast_exception_handler_kind_e;
